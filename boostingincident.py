...
data1 = pd.read_excel('HKCaR-incidence-EN.xlsx', sheet_name='2')
...
print("Linear Regression MSE for Male Incidence:", mse_lr_male)
print("Linear Regression MSE for Female Incidence:", mse_lr_female)
