...
file_path = 'HKCaR-incidence-ENG.xlsx'
data = load_and_clean_data(file_path)

# Plot for males
X_male, y_male = prepare_data(data, 'Male Age-Standardized Rate')
svm_regression_and_plot(X_male, y_male, 'SVM Regression: Male Age-Standardized Incidence Rate Over Time')

# Plot for females
X_female, y_female = prepare_data(data, 'Female Age-Standardized Rate')
svm_regression_and_plot(X_female, y_female, 'SVM Regression: Female Age-Standardized Incidence Rate Over Time')